...
| 11  | Используются ли системы или процессы контроля целостности данных?                                                                       |       Нет       |              Партнеры из УК могут видеть данные из других УК. |
...
| 1   | Используется ли межсетевой экран для ограничения входящего и исходящего трафика?                                                        |     Да  |      Есть фаерволл. Необходимо проверить его настройки.                     |
...
| 12  | Используются ли средства для контроля периметра доступа?                                                                                |       Да | Есть фаерволл. Необходимо проверить его настройки.             |
...
| 6   | Как часто проводятся внутренние и внешние аудиты безопасности? Обновляются ли политики и процедуры на основе результатов этих аудитов?  |        Нет | Но планируется провести аудит по ИБ для всей системы            |
